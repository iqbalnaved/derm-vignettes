...
# --- Save plots ---
plot_scatter("PCA1", "PCA2", "PCA Visualization (text-embedding-3-small)",
             f"/mnt/d/Naved/Outputs/derm_vignettes/pca_openai_{timestamp}.png")
plot_scatter("TSNE1", "TSNE2", "t-SNE Visualization (text-embedding-3-small)",
             f"/mnt/d/Naved/Outputs/derm_vignettes/tsne_openai_{timestamp}.png")
